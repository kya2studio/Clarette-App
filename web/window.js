...
async function settings(){
 ...
 if(section==='License'){
  ...
  html+=`<section><h2>Seller Settings</h2>${input('purchase_url','Purchase Link (shown as "Buy a License")')}<p style="color:#bdb3cf;font-size:12px;line-height:1.5;margin:8px 0 0">The URL the in-app "Buy a License" button opens (your Gumroad/Stripe/etc. product page).</p></section>`;
 }
